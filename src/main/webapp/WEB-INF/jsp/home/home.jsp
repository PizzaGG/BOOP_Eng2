	...
	<div class="container">
		<div class="d-flex align-items-center">
			<div class="navbar-profile-pic-div rounded-circle bg-dark-1">
				...
				<img src="<c:url value="/img/perfil.jpg"/>"
					class="navbar-profile-pic rounded-circle" alt="Jo�o Silva">
			</div>
			<a class="navbar-brand ml-3" href="#">Joao Silva</a>
		</div>
		<button class="navbar-toggler" type="button" data-toggle="collapse"
			data-target="#hidden-menu" aria-controls="hidden-menu"
		...
		<div class="collapse navbar-collapse" id="hidden-menu">
			<ul class="navbar-nav mt-1">
				...
				<li class="nav-item"><a class="nav-link text-primary" href="#">
						<i class="fas fa-book mr-2"></i> Livros
				</a></li>
				<li class="nav-item"><a class="nav-link text-primary" href="#">
						<i class="fas fa-exchange-alt mr-2"></i> Trocas
				</a></li>
							...
							<div class="row">
								<div class="col-md-4 col-sm-6 py-2">
									<div class="card shadow-sm">
										<div class="capa-livro-card">
											<img class="card-img-top capa-livro-card-img"
												src="<c:url value="/img/book1.jpg"/>" alt="Card image cap">
										</div>
										<div class="card-body">
											<h5 class="card-title">Livro Um</h5>
											<p class="card-text">
												Autor: Fulano de tal <br> ISBN: 0000000000000
											</p>
								...
								<div class="col-md-4 col-sm-6 py-2">
									<div class="card shadow-sm">
										<div class="capa-livro-card">
											<img class="card-img-top capa-livro-card-img"
												src="<c:url value="/img/book2.jpg"/>" alt="Card image cap">
										</div>
										<div class="card-body">
											<h5 class="card-title">Livro Dois</h5>
											<p class="card-text">
												Autor: Aquele Beltrano <br> ISBN: 0000000000000
											</p>
											<a href="#" class="card-link float-right">Editar</a>
										</div>
									</div>
								...
								<div class="col-md-4 col-sm-6 py-2">
									<div class="card shadow-sm">
										<div class="capa-livro-card">
											<img class="card-img-top capa-livro-card-img"
												src="<c:url value="/img/book3.jpg"/>" alt="Card image cap">
										</div>
										<div class="card-body">
											<h5 class="card-title">Livro Tres</h5>
											<p class="card-text">
												Autor: Sicraninho <br> ISBN: 0000000000000
											</p>
											<a href="#" class="card-link float-right">Editar</a>
										</div>
									</div>
				...
				<div class="card w-100 d-flex py-4">
					<div
						...
						<div
							...
							<!-- <h5 class="m-0">F</h5> -->
							<img src="<c:url value="/img/perfil.jpg"/>"
								class="sidebar-profile-pic" alt="João Silva">
						</div>
						...
						<ul class="nav nav-pills flex-column w-100 mt-4">
							<li class="nav-item side-item rounded"><a class="nav-link"
								href="../BOOP_Eng2/user"> <i class="fas fa-user mr-2"></i>
									Meu perfil
							</a></li>
							<li class="nav-item side-item rounded"><a class="nav-link"
								href="#"> <i class="fas fa-book mr-2"></i> Livros
							</a></li>
							<li class="nav-item side-item rounded"><a class="nav-link"
								href="#"> <i class="fas fa-exchange-alt mr-2"></i> Trocas
							</a></li>
							<div class="dropdown-divider"></div>
							<li class="nav-item side-item rounded"><a class="nav-link"
